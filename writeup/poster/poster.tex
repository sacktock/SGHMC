...
\author{Candidate Numbers: Sam Adam-Day, Alexander Goodall, 1060482 and Fanqi Xu}
...
Using our implementations we illustrate below how sampling algorithms differ from optimization algorithms; while sampling algorithms visit the full posterior $p(\theta \: | \: \mathcal{D})$ as they draw samples, optimization algoithms hone in on the MAP estimate $\text{argmax}_{\theta} \{ p(D \: | \: \theta) \cdot p(\theta) \}$. 
