...
\includesvg[width=\linewidth]{parts/Images/fig1a.svg}
...
\includesvg[width=0.6\linewidth]{parts/Images/fig1b.svg}
...
\begin{figure}[h!] 
    \centering
    \subfloat[Our reproduction]{%
        \includesvg[width=0.6\linewidth]{parts/Images/fig2a.svg}%
        }%
    \hfill%
    \subfloat[Figure from \cite{sghmc}]{%
        \includegraphics[width=0.6\linewidth]{parts/Images/reproduce1.png}%
        }%
...
\begin{figure}[htp] 
    \centering
    \subfloat[Our reproduction of autocorrelation time versus estimation error]{%
        \includesvg[width=0.5\linewidth]{parts/Images/fig3a.svg}%
        \label{fig:a}%
        }%
    \subfloat[Our reproduction of the first 50 samples of SGHMC and SGLD]{%
        \includesvg[width=0.5\linewidth]{parts/Images/fig3b.svg}%
        \label{fig:b}%
        }%
        \subfloat[From \cite{sghmc}]{%
        \includegraphics[width=0.5\linewidth]{parts/Images/reproduce3.png}%
        \label{fig:a}%
        }%
