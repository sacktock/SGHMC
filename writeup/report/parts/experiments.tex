...
\includesvg[width=.95\linewidth]{./parts/Images/fig1a.svg}
\caption{Distributions of different sampling algorithms for the target function $U(\theta) = -2\theta^2 + \theta^4$}
\label{fig1a}
\end{subfigure}%

\begin{subfigure}{\textwidth}
\includesvg[width=.95\linewidth]{./parts/Images/fig1b.svg}
...
\begin{figure}[htp] 
    \centering
    \subfloat[Step equals to 15000]{%
        \includesvg[width=0.6\linewidth]{./parts/Images/fig2a.svg}%
        \label{fig:a}%
        }%
    \hfill%
    \subfloat[Step equals to 150000]{%
        \includesvg[width=0.6\linewidth]{./parts/Images/fig2b.svg}%
        \label{fig:b}%
        }%
...
\begin{figure}[htp] 
    \centering
    \subfloat[Autocorrelation time versus estimation error for the five settings]{%
        \includesvg[width=0.5\linewidth]{./parts/Images/fig3a.svg}%
        \label{fig:a}%
        }%
    \hfill%
    \subfloat[First 50 samples of SGHMC and SGLD]{%
