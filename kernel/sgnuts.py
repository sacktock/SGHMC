...
#https://docs.pyro.ai/en/stable/_modules/pyro/infer/mcmc/nuts.html
...
class NUTS(SGHMC_for_NUTS):
    ...
    **References**
    ...
    def sample(self, params):
        ...
        self.potential_fn, nll_fn = self.get_potential_nll_functions(subsample=True)      

        # compute observed noise information
        if self.obs_info_noise:
            self.obs_info = self.compute_observed_information(params, nll_fn)
